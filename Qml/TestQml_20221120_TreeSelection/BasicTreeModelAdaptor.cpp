...
BasicTreeModelAdaptor::BasicTreeModelAdaptor(QObject *parent) :
    QAbstractListModel(parent), m_model(0), m_lastItemIndex(0),
    m_visibleRowsMoved(false), m_signalAggregatorStack(0)
{
}

QAbstractItemModel *BasicTreeModelAdaptor::model() const
{
    return m_model;
}

void BasicTreeModelAdaptor::setModel(QAbstractItemModel *arg)
{
    struct Cx {
        const char *signal;
        const char *slot;
...
void BasicTreeModelAdaptor::clearModelData()
{
    beginResetModel();
    m_items.clear();
...
const QModelIndex &BasicTreeModelAdaptor::rootIndex() const
{
    return m_rootIndex;
}

void BasicTreeModelAdaptor::setRootIndex(const QModelIndex &idx)
{
    if (m_rootIndex == idx)
        return;
...
void BasicTreeModelAdaptor::resetRootIndex()
{
    setRootIndex(QModelIndex());
}

QHash<int, QByteArray> BasicTreeModelAdaptor::roleNames() const
{
    if (!m_model)
...
int BasicTreeModelAdaptor::rowCount(const QModelIndex &) const
{
    return m_items.count();
}

QVariant BasicTreeModelAdaptor::data(const QModelIndex &index, int role) const
{
    if (!m_model)
        return QVariant();
...
bool BasicTreeModelAdaptor::setData(const QModelIndex &index, const QVariant &value, int role)
{
    if (!m_model)
        return false;
...
int BasicTreeModelAdaptor::itemIndex(const QModelIndex &index) const
{
...
bool BasicTreeModelAdaptor::isVisible(const QModelIndex &index)
{
    return itemIndex(index) != -1;
}

bool BasicTreeModelAdaptor::childrenVisible(const QModelIndex &index)
{
    return (index == m_rootIndex && !m_items.isEmpty())
            || (m_expandedItems.contains(index) && isVisible(index));
}

const QModelIndex &BasicTreeModelAdaptor::mapToModel(const QModelIndex &index) const
{
    return m_items.at(index.row()).index;
}

QPersistentModelIndex BasicTreeModelAdaptor::mapRowToModelIndex(int row) const
{
    if (!m_model)
        return QModelIndex();
...
QItemSelection  BasicTreeModelAdaptor::selectionForRowRange(const QModelIndex &fromIndex, const QModelIndex &toIndex) const
{
...
void BasicTreeModelAdaptor::showModelTopLevelItems(bool doInsertRows)
{
    if (!m_model)
        return;
...
void BasicTreeModelAdaptor::showModelChildItems(const TreeItem &parentItem, int start, int end, bool doInsertRows, bool doExpandPendingRows)
{
...
void BasicTreeModelAdaptor::expand(const QModelIndex &idx)
{
    ASSERT_CONSISTENCY();
    if (!m_model)
        return;
...
void BasicTreeModelAdaptor::collapse(const QModelIndex &idx)
{
    ASSERT_CONSISTENCY();
    if (!m_model)
        return;
...
bool BasicTreeModelAdaptor::isExpanded(const QModelIndex &index) const
{
    ASSERT_CONSISTENCY();
    if (!m_model)
        return false;
...
bool BasicTreeModelAdaptor::isExpanded(int row) const
{
    return m_items.at(row).expanded;
}

void BasicTreeModelAdaptor::expandRow(int n)
{
...
void BasicTreeModelAdaptor::expandPendingRows(bool doInsertRows)
{
...
void BasicTreeModelAdaptor::collapseRow(int n)
{
    if (!m_model || !isExpanded(n))
        return;
...
int BasicTreeModelAdaptor::lastChildIndex(const QModelIndex &index)
{
...
void BasicTreeModelAdaptor::removeVisibleRows(int startIndex, int endIndex, bool doRemoveRows)
{
...
void BasicTreeModelAdaptor::modelHasBeenDestroyed()
{
...
void BasicTreeModelAdaptor::modelHasBeenReset()
{
    clearModelData();
...
void BasicTreeModelAdaptor::modelDataChanged(const QModelIndex &topLeft, const QModelIndex &bottomRigth, const QVector<int> &roles)
{
...
void BasicTreeModelAdaptor::modelLayoutAboutToBeChanged(const QList<QPersistentModelIndex> &parents, QAbstractItemModel::LayoutChangeHint hint)
{
    ASSERT_CONSISTENCY();
    Q_UNUSED(parents);
    Q_UNUSED(hint);
...
void BasicTreeModelAdaptor::modelLayoutChanged(const QList<QPersistentModelIndex> &parents, QAbstractItemModel::LayoutChangeHint hint)
{
    Q_UNUSED(hint);
    if (parents.isEmpty()) {
        m_items.clear();
...
void BasicTreeModelAdaptor::modelRowsAboutToBeInserted(const QModelIndex & parent, int start, int end)
{
    Q_UNUSED(parent);
    Q_UNUSED(start);
    Q_UNUSED(end);
...
void BasicTreeModelAdaptor::modelRowsInserted(const QModelIndex & parent, int start, int end)
{
    TreeItem item;
...
void BasicTreeModelAdaptor::modelRowsAboutToBeRemoved(const QModelIndex & parent, int start, int end)
{
    ASSERT_CONSISTENCY();
...
void BasicTreeModelAdaptor::modelRowsRemoved(const QModelIndex & parent, int start, int end)
{
    Q_UNUSED(start);
    Q_UNUSED(end);
    int parentRow = itemIndex(parent);
...
void BasicTreeModelAdaptor::modelRowsAboutToBeMoved(const QModelIndex & sourceParent, int sourceStart, int sourceEnd, const QModelIndex & destinationParent, int destinationRow)
{
    ASSERT_CONSISTENCY();
    enableSignalAggregation();
...
void BasicTreeModelAdaptor::modelRowsMoved(const QModelIndex & sourceParent, int sourceStart, int sourceEnd, const QModelIndex & destinationParent, int destinationRow)
{
    if (!childrenVisible(sourceParent)) {
...
void BasicTreeModelAdaptor::dump() const
{
    if (!m_model)
        return;
...
bool BasicTreeModelAdaptor::testConsistency(bool dumpOnFail) const
{
    if (!m_model) {
        if (!m_items.isEmpty()) {
...
void BasicTreeModelAdaptor::enableSignalAggregation() {
    m_signalAggregatorStack++;
}

void BasicTreeModelAdaptor::disableSignalAggregation() {
    m_signalAggregatorStack--;
...
void BasicTreeModelAdaptor::queueDataChanged(const QModelIndex &topLeft,
...
void BasicTreeModelAdaptor::emitQueuedSignals()
{
