...
{
    Q_OBJECT
    Q_PROPERTY(QList<QString> filterOutputDevicesName READ getFilterOutputDevicesName NOTIFY filterOutputDevicesNameChanged)
...
public:
    ...
    //可用的输出设备列表
    Q_INVOKABLE QList<QString> getAllOutputDevicesName() const;
    //过滤采样率后-可用的输出设备列表
    Q_INVOKABLE QList<QString> getFilterOutputDevicesName() const;
